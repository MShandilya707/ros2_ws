...
#include <stddef.h>
#include "task_manager/srv/detail/querydata__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  task_manager__srv__Querydata_Request__init(message_memory);
}

void Querydata_Request__rosidl_typesupport_introspection_c__Querydata_Request_fini_function(void * message_memory)
{
  task_manager__srv__Querydata_Request__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Querydata_Request__rosidl_typesupport_introspection_c__Querydata_Request_message_member_array[1] = {
  {
    ...
    offsetof(task_manager__srv__Querydata_Request, structure_needs_at_least_one_member),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers Querydata_Request__rosidl_typesupport_introspection_c__Querydata_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(task_manager__srv__Querydata_Request),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, task_manager, srv, Querydata_Request)() {
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  task_manager__srv__Querydata_Response__init(message_memory);
}

void Querydata_Response__rosidl_typesupport_introspection_c__Querydata_Response_fini_function(void * message_memory)
{
  task_manager__srv__Querydata_Response__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Querydata_Response__rosidl_typesupport_introspection_c__Querydata_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(task_manager__srv__Querydata_Response, latest_data),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Querydata_Response__rosidl_typesupport_introspection_c__Querydata_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(task_manager__srv__Querydata_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_task_manager
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, task_manager, srv, Querydata_Response)() {
...
static rosidl_typesupport_introspection_c__ServiceMembers task_manager__srv__detail__querydata__rosidl_typesupport_introspection_c__Querydata_service_members = {
  "task_manager__srv",  // service namespace
  "Querydata",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // task_manager__srv__detail__querydata__rosidl_typesupport_introspection_c__Querydata_Request_message_type_support_handle,
  NULL  // response message
  // task_manager__srv__detail__querydata__rosidl_typesupport_introspection_c__Querydata_Response_message_type_support_handle
};

static rosidl_service_type_support_t task_manager__srv__detail__querydata__rosidl_typesupport_introspection_c__Querydata_service_type_support_handle = {
  0,
  &task_manager__srv__detail__querydata__rosidl_typesupport_introspection_c__Querydata_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, task_manager, srv, Querydata)() {
  if (!task_manager__srv__detail__querydata__rosidl_typesupport_introspection_c__Querydata_service_type_support_handle.typesupport_identifier) {
    task_manager__srv__detail__querydata__rosidl_typesupport_introspection_c__Querydata_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)task_manager__srv__detail__querydata__rosidl_typesupport_introspection_c__Querydata_service_type_support_handle.data;

  if (!service_members->request_members_) {
    service_members->request_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, task_manager, srv, Querydata_Request)()->data;
  }
  if (!service_members->response_members_) {
    service_members->response_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, task_manager, srv, Querydata_Response)()->data;
  }

  return &task_manager__srv__detail__querydata__rosidl_typesupport_introspection_c__Querydata_service_type_support_handle;
}
