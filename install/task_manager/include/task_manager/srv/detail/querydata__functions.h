...
#ifndef TASK_MANAGER__SRV__DETAIL__QUERYDATA__FUNCTIONS_H_
#define TASK_MANAGER__SRV__DETAIL__QUERYDATA__FUNCTIONS_H_
 ...
 * calls
 * task_manager__srv__Querydata_Request__init().
...
/**
 * It calls
 * task_manager__srv__Querydata_Request__fini()
 ...
 * task_manager__srv__Querydata_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * task_manager__srv__Querydata_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * task_manager__srv__Querydata_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_task_manager
...
/**
 * It calls
 * task_manager__srv__Querydata_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_task_manager
...
/**
 * It allocates the memory for the array and calls
 * task_manager__srv__Querydata_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_task_manager
...
/**
 * It calls
 * task_manager__srv__Querydata_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // TASK_MANAGER__SRV__DETAIL__QUERYDATA__FUNCTIONS_H_
