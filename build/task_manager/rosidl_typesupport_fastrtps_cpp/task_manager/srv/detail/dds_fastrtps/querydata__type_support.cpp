...
#include "task_manager/srv/detail/querydata__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const task_manager::srv::Querydata_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  task_manager::srv::Querydata_Request & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
...
{
  auto typed_message =
    static_cast<const task_manager::srv::Querydata_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<task_manager::srv::Querydata_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_task_manager
const rosidl_message_type_support_t *
get_message_type_support_handle<task_manager::srv::Querydata_Request>()
{
  return &task_manager::srv::typesupport_fastrtps_cpp::_Querydata_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, task_manager, srv, Querydata_Request)() {
  return &task_manager::srv::typesupport_fastrtps_cpp::_Querydata_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_task_manager
cdr_serialize(
  const task_manager::srv::Querydata_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: latest_data
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  task_manager::srv::Querydata_Response & ros_message)
{
  // Member: latest_data
  cdr >> ros_message.latest_data;
...
{
  auto typed_message =
    static_cast<const task_manager::srv::Querydata_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<task_manager::srv::Querydata_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &task_manager::srv::typesupport_fastrtps_cpp::_Querydata_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, task_manager, srv, Querydata_Response)() {
  return &task_manager::srv::typesupport_fastrtps_cpp::_Querydata_Response__handle;
}
...
{
  return &task_manager::srv::typesupport_fastrtps_cpp::_Querydata__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, task_manager, srv, Querydata)() {
  return &task_manager::srv::typesupport_fastrtps_cpp::_Querydata__handle;
}
