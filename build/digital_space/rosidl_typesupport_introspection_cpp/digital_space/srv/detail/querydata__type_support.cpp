...
{
  new (message_memory) digital_space::srv::Querydata_Request(_init);
}

void Querydata_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<digital_space::srv::Querydata_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Querydata_Request_message_member_array[1] = {
  {
    ...
    offsetof(digital_space::srv::Querydata_Request, structure_needs_at_least_one_member),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Querydata_Request_message_members = {
  "digital_space::srv",  // message namespace
  "Querydata_Request",  // message name
  1,  // number of fields
  sizeof(digital_space::srv::Querydata_Request),
...
{
  return &::digital_space::srv::rosidl_typesupport_introspection_cpp::Querydata_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, digital_space, srv, Querydata_Request)() {
  return &::digital_space::srv::rosidl_typesupport_introspection_cpp::Querydata_Request_message_type_support_handle;
}
...
void Querydata_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) digital_space::srv::Querydata_Response(_init);
}

void Querydata_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<digital_space::srv::Querydata_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Querydata_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(digital_space::srv::Querydata_Response, latest_data),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Querydata_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(digital_space::srv::Querydata_Response),
...
{
  return &::digital_space::srv::rosidl_typesupport_introspection_cpp::Querydata_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, digital_space, srv, Querydata_Response)() {
  return &::digital_space::srv::rosidl_typesupport_introspection_cpp::Querydata_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers Querydata_service_members = {
  "digital_space::srv",  // service namespace
  "Querydata",  // service name
  // these two fields are initialized below on the first access
  // see get_service_type_support_handle<digital_space::srv::Querydata>()
...
get_service_type_support_handle<digital_space::srv::Querydata>()
{
  ...
  auto service_type_support =
    &::digital_space::srv::rosidl_typesupport_introspection_cpp::Querydata_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, digital_space, srv, Querydata)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<digital_space::srv::Querydata>();
}
