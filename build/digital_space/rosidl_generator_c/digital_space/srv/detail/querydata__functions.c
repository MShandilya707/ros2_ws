...
digital_space__srv__Querydata_Request__create()
{
  ...
  digital_space__srv__Querydata_Request * msg = (digital_space__srv__Querydata_Request *)allocator.allocate(sizeof(digital_space__srv__Querydata_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(digital_space__srv__Querydata_Request));
  bool success = digital_space__srv__Querydata_Request__init(msg);
  if (!success) {
...
digital_space__srv__Querydata_Request__destroy(digital_space__srv__Querydata_Request * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    digital_space__srv__Querydata_Request__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
digital_space__srv__Querydata_Request__Sequence__init(digital_space__srv__Querydata_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  digital_space__srv__Querydata_Request * data = NULL;

  if (size) {
    data = (digital_space__srv__Querydata_Request *)allocator.zero_allocate(size, sizeof(digital_space__srv__Querydata_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = digital_space__srv__Querydata_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        digital_space__srv__Querydata_Request__fini(&data[i - 1]);
      }
...
digital_space__srv__Querydata_Request__Sequence__fini(digital_space__srv__Querydata_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      digital_space__srv__Querydata_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  digital_space__srv__Querydata_Request__Sequence * array = (digital_space__srv__Querydata_Request__Sequence *)allocator.allocate(sizeof(digital_space__srv__Querydata_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = digital_space__srv__Querydata_Request__Sequence__init(array, size);
  if (!success) {
...
digital_space__srv__Querydata_Request__Sequence__destroy(digital_space__srv__Querydata_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    digital_space__srv__Querydata_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
digital_space__srv__Querydata_Request__Sequence__are_equal(const digital_space__srv__Querydata_Request__Sequence * lhs, const digital_space__srv__Querydata_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!digital_space__srv__Querydata_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  digital_space__srv__Querydata_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(digital_space__srv__Querydata_Request);
    digital_space__srv__Querydata_Request * data =
      (digital_space__srv__Querydata_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!digital_space__srv__Querydata_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          digital_space__srv__Querydata_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!digital_space__srv__Querydata_Request__copy(
...
digital_space__srv__Querydata_Response__init(digital_space__srv__Querydata_Response * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->latest_data)) {
    digital_space__srv__Querydata_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  digital_space__srv__Querydata_Response * msg = (digital_space__srv__Querydata_Response *)allocator.allocate(sizeof(digital_space__srv__Querydata_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(digital_space__srv__Querydata_Response));
  bool success = digital_space__srv__Querydata_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
digital_space__srv__Querydata_Response__Sequence__init(digital_space__srv__Querydata_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  digital_space__srv__Querydata_Response * data = NULL;

  if (size) {
    data = (digital_space__srv__Querydata_Response *)allocator.zero_allocate(size, sizeof(digital_space__srv__Querydata_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = digital_space__srv__Querydata_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        digital_space__srv__Querydata_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
digital_space__srv__Querydata_Response__Sequence__fini(digital_space__srv__Querydata_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      digital_space__srv__Querydata_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  digital_space__srv__Querydata_Response__Sequence * array = (digital_space__srv__Querydata_Response__Sequence *)allocator.allocate(sizeof(digital_space__srv__Querydata_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = digital_space__srv__Querydata_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
digital_space__srv__Querydata_Response__Sequence__destroy(digital_space__srv__Querydata_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    digital_space__srv__Querydata_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
digital_space__srv__Querydata_Response__Sequence__are_equal(const digital_space__srv__Querydata_Response__Sequence * lhs, const digital_space__srv__Querydata_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!digital_space__srv__Querydata_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  digital_space__srv__Querydata_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(digital_space__srv__Querydata_Response);
    digital_space__srv__Querydata_Response * data =
      (digital_space__srv__Querydata_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!digital_space__srv__Querydata_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          digital_space__srv__Querydata_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!digital_space__srv__Querydata_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
